...
static void initDistance(double &distance) {
    distance = SignedDistance::MSDF_INFINITE.distance;
}

static void initDistance(MultiDistance &distance) {
    distance.r = SignedDistance::MSDF_INFINITE.distance;
    distance.g = SignedDistance::MSDF_INFINITE.distance;
    distance.b = SignedDistance::MSDF_INFINITE.distance;
}
